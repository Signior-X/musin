...
public class Welcome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Making Notification Bar transparent  -- NO idea What it is  -- The above notification bar!! To make it the color full screen! Yeah
        //Slightly different from full screen
        ...
        */
        setContentView(R.layout.activity_welcome); // Setting the view
    ...
    // Method to change the upper task manager like thing
